          ...
          children: [
            ...
            Padding(
              ...
              child: Wrap(
                ...
                children: List.generate(tagNames.length, (index) {
                  return ChoiceChip(
                    label: Text(tagNames[index], style: TextStyle(
                        color: selectedTags[index] ? Colors.white : Colors.black,
                        fontWeight: FontWeight.w500)),
                    selected: selectedTags[index],
                    selectedColor: const Color(0xff00A3E6),
                    backgroundColor: Colors.white,
                    side: BorderSide(color: selectedTags[index]
                        ? Colors.transparent : const Color(0xff00A3E6)),
                    onSelected: (selected) {
                      setState(() {
                        selectedTags[index] = selected;
                      });
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  IconButton(icon: const Icon(Icons.my_location, color: Colors.blue), onPressed: _showLocationDialog),
                ],
              ),
            ),
            const SizedBox(height: 30),
            ...
            Center(
              child: ElevatedButton(
                onPressed: () async {
                  if (mapController.text.isEmpty) {
                    ScaffoldMessenger.of(context).showSnackBar(
                      const SnackBar(content: Text('Эхлээд байршилын товчлуурыг дарна уу')),
                    );
                    return;
                  }
                  final selectedTagTexts = <String>[];
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => const SavedEntriesScreen()),
                  );
                },
                style: ElevatedButton.styleFrom(
                  backgroundColor: const Color(0xff00A3E6),
